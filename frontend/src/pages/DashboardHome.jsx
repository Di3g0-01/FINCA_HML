...
export default function DashboardHome() {
  ...
  return (
    <div className="fade-in">
      ...
      {isLoading ? ( <div style={{ color: 'var(--text-muted)' }}>Cargando estadísticas...</div> ) : isError ? (
        <div style={{ color: 'var(--danger-color)' }}>Ocurrió un error al cargar las estadísticas.</div>
      ) : (
        <>
