  ...
  useEffect(() => {
    if (workerToEdit) {
      setFormData({
        ...
        is_active:
          workerToEdit.is_active !== undefined ? workerToEdit.is_active : true,
        is_retired:
          workerToEdit.is_retired !== undefined
            ? workerToEdit.is_retired
            : false,
      });
    } else {
      setFormData({
  ...
  return createPortal(
    <div className="modal-overlay fade-in">
      ...
      >
        ...
        <h2
          style={{ fontSize: '1.5rem', marginBottom: '8px', color: '#4CAF50' }}
        >
