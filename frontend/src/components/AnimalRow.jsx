    ...
    return (
      <Fragment>
        ...
        >
          ...
          <td
            style={{ padding: '16px', paddingLeft: isChild ? '32px' : '16px' }}
          >
            <div
              style={{
                display: 'flex',
            ...
            >
              ...
              {animal.identifier}
              {!isChild && !isMother && animal.origin === 'COMPRA' && (
                <Tag
                  size={14}
                  color="#2196F3"
                  title="Animal de Compra Externa"
                />
              )}
            </div>
          </td>
          ...
          <td
            style={{
              ...
              fontWeight: 'bold',
              color:
                animal.total_calvings > 0 ? '#FF9800' : 'var(--text-muted)',
            }}
          >
            {['VACA', 'NOVILLA', 'CHIVA', 'DESMADRE_HEMBRA'].includes(
              animal.type,
            )
              ? animal.total_calvings || 0
              : '-'}
          </td>
          <td style={{ padding: '16px', color: 'var(--text-muted)' }}>
            {viewMode === 'CALVING'
              ? animal.last_calving_date
                ? formatDate(animal.last_calving_date)
                : 'N/A'
              : animal.birth_date
          ...
          {viewMode === 'CALVING' ? (
            <>
              <td
                style={{
                  padding: '16px',
                  color: animal.is_pregnant ? '#FF9800' : 'var(--text-muted)',
                  fontWeight: 'bold',
                }}
              >
                {animal.is_pregnant
              ...
              <td
                style={{
                  padding: '16px',
                  color: animal.is_pregnant ? '#10B981' : 'var(--text-muted)',
                  fontWeight: 'bold',
                }}
              >
                {animal.is_pregnant
            ...
            >
              {animal.current_weight ? animal.current_weight + ' lbs' : '-'}
            </td>
          )}
        </tr>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      Historial Ginecológico y Médico
                    </h4>
                    <div
                      style={{
                        display: 'flex',
                      ...
                      {['VACA', 'NOVILLA', 'CHIVA', 'DESMADRE_HEMBRA'].includes(
                        ...
                        <>
                          ...
                          >
                            ...
                            <span>{animal.total_calvings || 0}</span>
                          </div>
                          <div
                            style={{
                              display: 'flex',
                          ...
                          >
                            ...
                            <span>
                              {animal.second_last_calving_date
                                ? formatDate(animal.second_last_calving_date)
                                : 'N/A'}
                            </span>
                          </div>
                        </>
                        ...
                        >
                          El módulo ginecológico solo aplica biológicamente a
                          las hembras.
                        </div>
                      )}
                      <div
                  ...
                  {viewMode === 'CALVING' ? (
                    ...
                    >
                      ...
                      {animal.is_pregnant ? (
                        ...
                        >
                          No hay gestación activa para predecir.
                        </div>
                      )}
                    </div>
                  ) : (
                    ...
                    >
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          onDelete(animal.id, animal.identifier);
                        }}
                        className="btn-secondary"
                        style={{
                          width: '100%',
